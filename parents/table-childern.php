...
<div class="content-body">
    <div class="container-fluid">
        ...
        <?php 
       $rowid = $_SESSION['user'];  
        $sql = "SELECT * FROM `child detail` where parent_id = ". $rowid;
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-success"><a href="update.php?id=<?php echo $row["id"] ?>" class="text-light"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                                <button class="btn btn-danger"><a href="delete.php?id=<?php echo $row["id"] ?>" class="text-light"><i class="fa-solid fa-trash"></i></button></a>
                                            </td>
                                            </td>
