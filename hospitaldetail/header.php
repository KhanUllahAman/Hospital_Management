                                    ...
                                    <div class="profile_info">
                                        ...
                                        <div>
                                            <?php if (isset($_SESSION['hospital'])) : ?>
                                                <strong class="text-light"><?php echo $_SESSION['hospital']; ?></strong>

                                                <small>
                                                    <i style="color: #888;" class="d-none">(<?php echo ucfirst($_SESSION['hospital']); ?>)</i>
